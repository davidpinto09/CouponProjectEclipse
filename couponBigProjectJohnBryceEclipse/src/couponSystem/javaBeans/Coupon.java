...
public class Coupon {
    ...
    public Coupon(int couponId, int companyId, Category couponCategory, String couponTitle, String couponDescription, LocalDate couponStartDate, LocalDate couponEndDate, int couponAmount, double couponPrice, String couponImage) {
    ...
    public Coupon(int companyId, Category couponCategory, String couponTitle, String couponDescription, LocalDate couponStartDate, LocalDate couponEndDate, int couponAmount, double couponPrice, String couponImage) {
        setCompanyId(companyId);
        setCouponAmount(couponAmount);
        setCouponCategory(couponCategory);
        setCouponTitle(couponTitle);
    ...
    public enum Category {
        ...
        FOOD, ELECTRICITY, RESTAURANT, VACATION, LIFESTYLE_AND_HEALTH, CULTURE_AND_ENTERTAINMENT, SPORTS, GAMES, SHOPPING,
    }
