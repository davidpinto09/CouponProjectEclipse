...
public class ConnectionPool {
	...
	/**
	 * Private constructor for singleton class that add connections to the
	...
	private ConnectionPool() throws SQLException {
		...
		for (int i = 0; i < TOTAL_CONNECTIONS; i++) {
			...
			this.connections
					.add(DriverManager.getConnection(getDatabaseUrl(), getDatabaseUser(), getDatabasePassword()));
	...
	/**
	 * @return one connection from the Collection of connections in the
	 *         connectionPool
	 */
	...
	/**
	 * Restores the used connection back to the Collection connections in
	 * collectionPool
	 *
