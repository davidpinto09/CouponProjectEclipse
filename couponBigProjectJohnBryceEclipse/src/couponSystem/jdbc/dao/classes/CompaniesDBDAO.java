...
public class CompaniesDBDAO implements CompaniesDAO {
    ...
    public boolean isCompanyExists(String companyEmail, String companyPassword) throws CouponSystemException {
        ...
        try {
            ...
            String sql = "SELECT COMPANY_EMAIL, COMPANY_PASSWORD FROM COMPANIES WHERE COMPANY_EMAIL = " + "\"" + companyEmail + "\"" + " AND COMPANY_PASSWORD = " + "\"" + companyPassword + "\"";
    ...
    public boolean isCompanyInDatabase(String companyName, String companyEmail) throws CouponSystemException {
        ...
        try {
            connection = getConnectionPool().getConnection();
            String sql = "SELECT COMPANY_NAME, COMPANY_EMAIL FROM COMPANIES WHERE COMPANY_NAME = " + "\"" + companyName + "\"" + " AND COMPANY_EMAIL = " + "\"" + companyEmail + "\"";
    ...
    public void updateCompany(Company company) throws CouponSystemException {
        ...
        try {
            connection = getConnectionPool().getConnection();
            String sql = "UPDATE COMPANIES SET COMPANY_EMAIL=?,COMPANY_PASSWORD=? WHERE COMPANY_ID = " + company.getCompanyId();
    ...
    public void deleteCompany(int companyId) throws CouponSystemException {
        ...
        try {
            ...
            if (actualCompanyRow == 0) {
                throw new DAOException("Deleting Company with id " + companyId + " failed because it is not in the DataBase");
            }
        } catch (SQLException sqlException) {
