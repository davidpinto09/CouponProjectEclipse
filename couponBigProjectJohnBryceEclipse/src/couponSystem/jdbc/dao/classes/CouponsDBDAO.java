...
public class CouponsDBDAO implements CouponsDAO {
    ...
    public Coupon getOneCoupon(int couponId) throws CouponSystemException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                return new Coupon(companyID, category, couponTitle, couponDescription,
                        couponStartDate, couponEndDate, couponAmount, couponPrice, couponImage);
            }
    ...
    public boolean isPurchaseExist(int customerId, int couponId) throws CouponSystemException {
        ...
        try {
            connection = getConnectionPool().getConnection();
            String sql = "SELECT * FROM customers_vs_coupons WHERE CUSTOMER_ID = " + customerId + " AND COUPON_ID = " + couponId;
            PreparedStatement ps = connection.prepareStatement(sql);
