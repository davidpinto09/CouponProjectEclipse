...
public interface CouponsDAO {
    ...
    /**
     * Before that a company can adds a coupon this method verifies that the title of the coupon to add is not related to the company who tries to add
     * This method verifies if the company created a coupon wi using the title  exists in database
     *
     ...
     * @throws DAOException data access object exception if the process of finding the coupon fail
     */
     ...
     * @param coupon to add
     *                   @throws CouponSystemException
     * @throws DAOException if data from parameter does not accord the table values
     */
     ...
     *     @throws CouponSystemException
     * @throws DAOException if there is no Coupons with the specify couponId in
     *                      DataBase
     */
