...
public interface CompaniesDAO {
     ...
     * @return true if the company parameters match with at least 1 object in database else false
     * @throws CouponSystemException
     ...
     * @throws CouponSystemException
     * @throws DAOException          if there is no Company with the specify companyId in DataBase
     */
