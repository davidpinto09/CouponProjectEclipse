...
public class CustomerFacade extends ClientFacade {
    ...
    /**
     * The Coupon will be add only once to the actual Customer coupons if Customer does not purchase the same coupon before
     * The Coupon will not be added in Customer coupons if his amount is less or equal to 0;
     * If the end date of the coupon purchase is equal to actual date of purchase the coupon cannot be added
     * If the coupon is added the amount of this coupon must be subtracted by -1
     *
    ...
    /**
     * This method return all available coupons with the specified category for the actual Customer
     *
    ...
    public Collection<Coupon> getAllCustomerCouponsByCategory(Coupon.Category category) throws CouponSystemException {
        ...
        return couponsDAO.getCouponsBy(CouponsDBDAO.getAllCustomerCouponsByCategory, this.customerId, category.ordinal() + 1);

    }

    /**
     * This method return all available coupons below or less than @param maxPrice for the actual Customer
     *
