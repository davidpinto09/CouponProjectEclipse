...
public class AdminFacade extends ClientFacade {
    ...
    public void addCompany(Company company) throws CouponSystemException {
        if (!companiesDAO.isCompanyInDatabase(company.getCompanyName(), company.getCompanyEmail())) {
            ...
            throw new FacadeException("Adding Company " + company.getCompanyName() + " failed - Company already exists in database");
        }

    }

    /**
     * Update the all fields of company without changing @param companyId and @param companyName of actual Company
     *
    ...
    public void updateCompany(Company company) throws CouponSystemException {
        if (companiesDAO.isCompanyInDatabase(company.getCompanyName(), company.getCompanyEmail())) {
            ...
            throw new FacadeException("Updating Company " + company.getCompanyName() + " failed - Company does not exist in database");
        }
    }

    /**
     * Delete from database the Company from the parameter received with all the Company Coupons and all Purchase Coupons
     *
    ...
    public void addCustomer(Customer customer) throws CouponSystemException, FacadeException {
        if (!customersDAO.isCustomerInDataBase(customer.getCustomerEmail())) {
            ...
            throw new FacadeException("Adding Customer " + customer.getCustomerFirstName() + " " + customer.getCustomerLastName() + " failed - Customer already exists");
        }
    }

    /**
     * Update the all fields of customer without changing @param customerId of actual customer
     *
    ...
    public void updateCustomer(Customer customer) throws CouponSystemException {
        if (customersDAO.isCustomerInDataBase(customer.getCustomerEmail())) {
            ...
            throw new FacadeException("Updating Customer " + customer.getCustomerFirstName() + " " + customer.getCustomerLastName() + " failed - Customer does not exist in database");
        }
    }

    /**
     * Delete from database the Customer from the parameter received with all the Purchase Coupons
     *
