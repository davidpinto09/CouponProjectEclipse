...
public class CompanyFacade extends ClientFacade {
    ...
    /**
     * Update the actual coupon without the @param coupon_id and @param company_name for the actual company
     *
     ...
     * @throws CouponSystemException
     * @throws DAOException          if the actual company has not coupon with the specified category
     * @throws FacadeException
     */
    public Collection<Coupon> getAllCompanyCouponsByCategory(Coupon.Category category) throws CouponSystemException {


        return couponsDAO.getCouponsBy(CouponsDBDAO.getAllCompanyCouponsByCategory, this.companyID, category.ordinal() + 1);
     ...
     * @throws FacadeException       if the company has not coupons below or equal to @param maxPrice
     */
